...
<body class="animsition">
	...
	<jsp:include page="cozastore-master/include/topMenu.jsp" />

	<!-- Cart -->
	<form action = "/ShoppingMall/yourcart.do" method="post" onsubmit="return checkForm()">
	<div class="wrap-header-cart js-panel-cart">
		<div class="s-full js-hide-cart"></div>
	<input type="submit"/>
	</form>	
	<jsp:include page="cozastore-master/cart/yourcart.jsp" />
	<!--
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url(cozastore-master/images/banner.07.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							...
							<div class="layer-slick1 animated visible-false" data-appear="zoomIn" data-delay="1600">
								<a href="product.do" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
									Shop Now
								</a>
							</div>
						</div>
				...
				<div class="item-slick1" style="background-image: url(cozastore-master/images/m01.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
			...
			<div class="row">
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="cozastore-master/images/wimg.png" alt="IMG-BANNER">

						<a href="product.do" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="cozastore-master/images/simg01.png" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="cozastore-master/images/yimg.png" alt="IMG-BANNER">
	 ...
	 <section class="bg0 p-t-23 p-b-140">
					...
					<div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
						<div class="filter-col1 p-r-15 p-b-27">
							...
							<ul>
								...
								<li class="p-b-6">
									<a href="product.do" class="filter-link stext-106 trans-04">
										Popularity
									</a>
								</li>
								...
								<li class="p-b-6">
									<a href="product.do" class="filter-link stext-106 trans-04 filter-link-active">
										Newness
									</a>
								</li>
		...
		<!-- 상품들 -->
			<!-- <div class="row isotope-grid">
			 ...
			 <div class="row isotope-grid">
			 <c:forEach var="item" items="${itemList}" begin="1" end="4">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">			
		...
		<!--Load more -->
			<div class="flex-c-m flex-w w-full p-t-45">
				<a href="/ShoppingMall/product.do" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04">
					Load More
				</a>
			</div>
		</div>
	...
	<!--  footer  -->
	<footer>
<jsp:include page="cozastore-master/include/footer.jsp" />
	</footer>
						...
						<div class="p-l-25 p-r-30 p-lr-0-lg">
							<div class="wrap-slick3 flex-sb flex-w">
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="cozastore-master/images/product-detail-01.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="cozastore-master/images/product-detail-01.jpg" alt="IMG-PRODUCT">
									...
									<div class="item-slick3" data-thumb="cozastore-master/images/product-detail-02.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="cozastore-master/images/product-detail-02.jpg" alt="IMG-PRODUCT">
									...
									<div class="item-slick3" data-thumb="images/product-detail-03.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="cozastore-master/images/product-detail-03.jpg" alt="IMG-PRODUCT">
