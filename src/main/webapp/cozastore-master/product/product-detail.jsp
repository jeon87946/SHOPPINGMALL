...
<!--===============================================================================================-->	
	<link rel="stylesheet" type="text/css" href="/ShoppingMall/cozastore-master/vendor/daterangepicker/daterangepicker.css">
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="/ShoppingMall/cozastore-master/vendor/slick/slick.css">
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="/ShoppingMall/cozastore-master/vendor/MagnificPopup/magnific-popup.css">
<!--===============================================================================================-->
...
<body class="animsition">
			...
			<div class="header-cart-content flex-w js-pscroll">
				...
				<div class="w-full">
					...
					<div class="header-cart-buttons flex-w w-full">
						<a href="/ShoppingMall/cozastore-master/cart/shoping-cart.jsp" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-r-8 m-b-10">
							View Cart
						</a>

						<a href="/ShoppingMall/cozastore-master/cart/shoping-cart.jsp" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-b-10">
							Check Out
						</a>
					</div>
				</div>
	...
	<div class="container">
		<div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
			<a href="/ShoppingMall/index.jsp" class="stext-109 cl8 hov-cl1 trans-04">
				<!-- Home -->
				<i class="fa fa-angle-right m-l-9 m-r-10" aria-hidden="true"></i>
			</a>

			<a href="/ShoppingMall/cozastore-master/product/product.jsp" class="stext-109 cl8 hov-cl1 trans-04">
				<!-- Men -->
				<i class="fa fa-angle-right m-l-9 m-r-10" aria-hidden="true"></i>
			</a>
				...
				<div class="col-md-6 col-lg-7 p-b-30">
					...
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						...
						<div class="p-t-33">
							...
							<form action = "cart.do" method="post" name="productCnt" onsubmit="return checkForm()">
							<div class="flex-w flex-r-m p-b-10">
				...
				<div class="tab01">
					...
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item p-b-10">
							<a class="nav-link active" data-toggle="tab" href="#description" role="tab">상품소개</a>
						</li>
									...
									<div class="p-b-30 m-lr-15-sm">
										...
										<div class="flex-w flex-t p-b-68">
											<div class="wrap-pic-s size-109 bor0 of-hidden m-r-18 m-t-6">
												<img src="/ShoppingMall/cozastore-master/images/avatar-01.jpg" alt="AVATAR">
											</div>
							...
							<div class="block2-txt flex-w flex-t p-t-14">
								...
								<div class="block2-txt-child2 flex-r p-t-3">
									<a href="#" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
										<img class="icon-heart1 dis-block trans-04" src="/ShoppingMall/cozastore-master/images/icons/icon-heart-01.png" alt="ICON">
										<img class="icon-heart2 dis-block trans-04 ab-t-l" src="/ShoppingMall/cozastore-master/images/icons/icon-heart-02.png" alt="ICON">
									</a>
								</div>
							</div>
							</div>
		...
		<div class="container">
			<div class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent">
				<button class="how-pos3 hov3 trans-04 js-hide-modal1">
					<img src="/ShoppingMall/cozastore-master/images/icons/icon-close.png" alt="CLOSE">
				</button>
					...
					<div class="col-md-6 col-lg-7 p-b-30">
						<div class="p-l-25 p-r-30 p-lr-0-lg">
							<div class="wrap-slick3 flex-sb flex-w">
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="/ShoppingMall/cozastore-master/images/product-detail-01.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="/ShoppingMall/cozastore-master/images/product-detail-01.jpg" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="/ShoppingMall/cozastore-master/images/product-detail-01.jpg">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>

									<div class="item-slick3" data-thumb="/ShoppingMall/cozastore-master/images/product-detail-02.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="/ShoppingMall/cozastore-master/images/product-detail-02.jpg" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="/ShoppingMall/cozastore-master/images/product-detail-02.jpg">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>

									<div class="item-slick3" data-thumb="/ShoppingMall/cozastore-master/images/product-detail-03.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="/ShoppingMall/cozastore-master/images/product-detail-03.jpg" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="/ShoppingMall/cozastore-master/images/product-detail-03.jpg">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>
					...
					<div class="col-md-6 col-lg-5 p-b-30">
						<div class="p-r-50 p-t-5 p-lr-0-lg">
							...
							<div class="p-t-33">
								...
								<form action = "/ShoppingMall/kr/ac/kopo/controller/CartController.java" method="post" name="productCnt" onsubmit="return checkForm()">			
...
<!--===============================================================================================-->
	<script src="/ShoppingMall/cozastore-master/vendor/daterangepicker/moment.min.js"></script>
	<script src="/ShoppingMall/cozastore-master/vendor/daterangepicker/daterangepicker.js"></script>
<!--===============================================================================================-->
	<script src="/ShoppingMall/cozastore-master/vendor/slick/slick.min.js"></script>
	<script src="/ShoppingMall/cozastore-master/js/slick-custom.js"></script>
<!--===============================================================================================-->
	<script src="/ShoppingMall/cozastore-master/vendor/parallax100/parallax100.js"></script>
	<script>
...
<!--===============================================================================================-->
	<script src="/ShoppingMall/cozastore-master/vendor/isotope/isotope.pkgd.min.js"></script>
<!--===============================================================================================-->
	<script src="/ShoppingMall/cozastore-master/vendor/sweetalert/sweetalert.min.js"></script>
	<script>
